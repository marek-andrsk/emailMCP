...
| `draft_reply_email` | Save a reply draft to IMAP Drafts folder (does NOT send) |
| `draft_new_email` | Save a NEW (non-reply) draft to IMAP Drafts folder (does NOT send) |
